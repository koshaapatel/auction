            ...
            $http({
                ...
                $scope.Timer = $interval(function () {
                    for (var i = 0; i < data.length; i++) {
                        $scope.timeRemaining[i] = ((data[i].startTimeStamp + 90000) - new Date().getTime()) / 1000;
                        //  $scope.KeyTurn[i] = true;
                        console.log("timer");
                        // console.log($scope.Timer[i]);
                        console.log($scope.timeRemaining[i]);
                    }
                }, 1000);
...
//                     if(data.length > 0) {
//                         $scope.Timer = $interval(function () {
//                             $scope.timeRemaining = ((data[i].startTimeStamp + 90000) - new Date().getTime()) / 1000;
//                             $scope.KeyTurn = true;
//                         }, 1000);
//                         console.log("scope time remaining");
